    ...
    return (
        <div className='flex justify-center fixed z-50 bottom-0 py-4 w-full bg-white'>
            <div className='flex items-center px-3 justify-between border border-gray-500 w-[90%] h-16 rounded-lg'>
                <Link to='/packages' className={`flex flex-col justify-center items-center`}>
                ...
                <Link to='/cart' className='flex flex-col justify-center items-center relative'>
                    ...
                    <div className='absolute flex items-center justify-center top-0 -right-2 size-5 bg-red-500 rounded-full text-white'>{getTotalCartItems()}</div>
                </Link>
