...
const SpecialInqueryDeal = () => {
    const { UrlBackend, dealId, profile } = useContext(AppContext)

    const id = profile?._id
    const selectedPackage = deals.find((pkg) => pkg.id.toString() === dealId);
    ...
    return (
        <div className="mt-5 text-center">
            ...
            <div className='flex flex-col items-center gap-2 mt-10'>
                ...
                <p className='px-2'>{selectedPackage?.name}</p>
            </div>
...
export default SpecialInqueryDeal