...
const DetailPackage = () => {
    ...
    return (
        <div className='flex flex-col px-3 pt-3 pb-24'>
            ...
            <p className='mt-7'><span className='text-xl text-green-500 font-medium'>Available  </span> - <span className='text-blue-500 text-base underline'> Do you have any question ?</span></p>
            ...
            <button className='mt-8 w-full py-5 bg-orange-600 rounded-full text-white text-2xl'>Add To Cart</button>
        </div >
    )
}
