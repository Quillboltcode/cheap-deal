...
const DetailPackage = () => {
    ...
    const { setPackageId, addToCart,indexData, setIndexData, priceData, setPriceData } = useContext(AppContext)
    ...
    return (
        <div className='flex flex-col px-3 pt-3 pb-24'>
            ...
            <p className='mt-7'><span className='text-xl text-green-500 font-medium'>Available  </span> - <span onClick={() => { navigate('/special-inquery'), setPackageId(id) }} className='text-blue-500 text-base underline'> Do you have any question ?</span></p>

            <hr className='mt-5 bg-gray-300 h-0.5' />


            {selectedPackage.type === "device + data" ?
